                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تعديل بيانات معدة وعميل
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">تحديث بيانات المعدة والعميل</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form form-prevent-multiple-submits" action="{{ route('admin.update.customer.Card',$customer_card->id) }}" method="POST"
                                          ...
                                          @csrf
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-feather"></i>عدل بيانات المعدة</h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ $customer_card->card_no }}" id="card_no"
                                                               class="form-control"
                                            ...
                                            <h4 class="form-section"><i class="la la-user-plus"></i>عدل بيانات العميل</h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
