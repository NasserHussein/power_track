                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form form-prevent-multiple-submits" action="{{ route('admin.update_report.customer.maintenance',$customer_maintenance->id) }}" method="POST"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" id="notes"class="form-control" name="notes" placeholder="أدخل ملاحظاتك هنا....." readonly>{{ $customer_maintenance->notes }}</textarea>
                                                            @error('notes')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="technicians[]" id="profession" class="form-control authes" style="width: 435px" multiple>
                                                            ...
                                                            @foreach ($techicians as $technician)
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1">تاريخ التسليم</label>
                                                        <input type="date" value="{{ $customer_maintenance->delivery_date }}" id="delivery_date"
                                                               class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="@if($customer_maintenance->maintenance_cost == null){{ old('maintenance_cost') }}@endif @if($customer_maintenance->maintenance_cost !== null){{ $customer_maintenance->maintenance_cost }}@endif" id="maintenance_cost"
                                                               class="form-control"
