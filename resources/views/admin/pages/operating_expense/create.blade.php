                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">أضافة مصروف
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">تسجيل مصروف جديد</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form form-prevent-multiple-submits" action="{{ route('admin.store.operating.expenses') }}" method="POST"
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-feather"></i>أضف المصروف الجديد</h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('person_responsible_for_payment') }}" id="person_responsible_for_payment"
                                                               class="form-control"
