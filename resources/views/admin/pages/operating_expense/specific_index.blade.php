...
@section('title')
أجمالي المصروفات في فترة محددة
@endsection
@section('content')
<style>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">أجمالي المصروفات في فترة محددة</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">أجمالي المصروفات في فترة محددة
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="la la-wrench"></i> أجمالي المصروفات في الفترة من يوم <span style="color: red"> {{ $start }} </span> إلي يوم <span style="color: red"> {{ $end }} </span> هو {{ $sum }}$</h4>
