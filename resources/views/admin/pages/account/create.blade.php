...
@section('title')
إضافة فاتورة للعميل {{ $customer->company_name }}
@endsection
@section('content')
<style>
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">أضافة فاتورة
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">تسجيل فاتورة للعميل {{ $customer->company_name }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form form-prevent-multiple-submits" action="{{ route('admin.store.account',$customer->id) }}" method="POST"
                                          enctype="multipart/form-data">
                                          @csrf

                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-feather"></i>أضف بيانات الفاتورة الجديدة</h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1" required>رقم الفاتورة</label>
                                                        <input type="text" value="{{ old('invoice_number') }}" id="invoice_number"
                                                               class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('invoice_value') }}" id="invoice_value"
                                                               class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" value="{{ old('invoice_date') }}" id="invoice_date"
                                                               class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" id="invoice_data"class="form-control" name="invoice_data">{{ old('invoice_data') }}</textarea>
                                                               @error('invoice_data')
                                                               <span class="text-danger">{{ $message }}</span>
                                                               @enderror
                                                    </div>
