    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">الأخطارات الغير نشطة</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.maintenance_Notifie.index_ac') }}">الأخطارات النشطة</a>
                            </li>
                            <li class="breadcrumb-item active">الأخطارات الغير نشطة
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="la la-group"></i> جميع  الأخطارات الغير نشطة </h4>
                                            ...
                                            @foreach ($notifies_de as $notifie_de)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('admin.maintenance_Notifie.delete',$notifie_de->id) }}" class="btn mr-1 mb-1 btn-danger btn-sm">
                                                            حذف
                                                        </a>
                                                    </td>
                                                </tr>
