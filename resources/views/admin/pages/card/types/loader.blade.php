    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"> اللوادر </h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item active"> اللوادر
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="la la-group"></i> جميع اللوادر المسجلة {{ $cards->count() }} لودر</h4>
                                                                ...
                                                                <div class="modal-dialog modal-xl" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title" id="myModalLabel16">تفاصيل إضافية عن اللودر</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">×</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <h5>تفاصيل إضافية عن اللودر</h5>
                                                                            <div class="table-responsive">
                                                                                <table class="table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th scope="row">عداد اللودر الحالي بالساعات</th>
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table table-striped bg-info mb-0 white">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>عداد اللودر بالساعات عند تغيير الزيت</td>
                                                                                        <td>{{ $card->oil_hours }} ساعة</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>عداد اللودر بالساعات حاليا</td>
                                                                                        <td>{{ $card->card_hours }} ساعة</td>
                                                                                    </tr>
                                                                                    <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal animated bounceIn text-left" id="delete{{ $card->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel46" style="display: none;" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title" id="myModalLabel46">حذف بيانات اللودر</h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">×</span>
                                                                        </button>
                                                                    </div>
                                                        ...
                                                        <button type="button" data-toggle="modal" data-target="#OilRegistration{{ $card->id }}" class="btn mr-1 mb-1 btn-success btn-sm round">تم تغيير زيت لللودر</button>
                                                        {{-- ----Start Modal---- --}}
                                                        <div class="modal animated tada text-left" id="OilRegistration{{ $card->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel43" style="display: none;" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title" id="myModalLabel43">تغير زيت لللودر</h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">×</span>
                                                                        </button>
                                                                    </div>
