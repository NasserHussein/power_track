    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"> الكسارات </h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">الرئيسية</a>
                            </li>
                            <li class="breadcrumb-item active"> الكسارات
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="la la-group"></i> جميع الكسارات المسجلة {{ $cards->count() }} كسارة</h4>
                                                                ...
                                                                <div class="modal-dialog modal-xl" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title" id="myModalLabel16">تفاصيل إضافية عن الكسارة</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">×</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <h5>تفاصيل إضافية عن الكسارة</h5>
                                                                            <div class="table-responsive">
                                                                                <table class="table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th scope="row">عداد الكسارة الحالي بالساعات</th>
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table table-striped bg-info mb-0 white">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>عداد الكسارة بالساعات عند تغيير الزيت</td>
                                                                                        <td>{{ $card->oil_hours }} ساعة</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>عداد الكسارة بالساعات حاليا</td>
                                                                                        <td>{{ $card->card_hours }} ساعة</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>عدد الكسارة المستهلكة بعد تغيير الزيت</td>
                                                                                        <td>{{ $card->hours_used }} ساعة</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>عدد الكسارة المتبقية لتغيير الزيت</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal animated bounceIn text-left" id="delete{{ $card->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel46" style="display: none;" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title" id="myModalLabel46">حذف بيانات الكسارة</h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">×</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <h5 style="color: red">هل متأكد من حذف بيانات الكسارة</h5>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                        ...
                                                        <div class="modal animated tada text-left" id="OilRegistration{{ $card->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel43" style="display: none;" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title" id="myModalLabel43">تغير زيت للكسارة</h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">×</span>
                                                                        </button>
                                                                    </div>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label for="projectinput1">عداد الكسارة بالساعات</label>
                                                                                    <input type="text" value="{{ old('oil_hours') }}" id="oil_hours"
                                                                                        class="form-control"
                                                                                        placeholder="أدخل عداد الكسارة بالساعات"
                                                                                        name="oil_hours">
                                                                                        @error('oil_hours')
                                                                                        <span class="text-danger">{{ $message }}</span>
                                                                                        @enderror
