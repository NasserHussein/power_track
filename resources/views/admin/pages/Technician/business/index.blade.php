                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="la la-wrench"></i> جميع أعمال أعمال {{ $technical_skills }} {{ $techician_name }} من الفترة <span style="color: red">{{ $start }}</span> إلي <span style="color: red">{{ $end }}</span> = <span style="color: green;font-size: 20px;background-color: yellow;font-weight: bold">{{ $count }} عمليات صيانة</span></h4>
