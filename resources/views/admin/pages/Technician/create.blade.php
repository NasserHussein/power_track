                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">أضافة فني
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">تسجيل بيانات الفني</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form form-prevent-multiple-submits" action="{{ route('admin.store.technician') }}" method="POST"
                                          enctype="multipart/form-data">
                                          @csrf

                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-feather"></i>أضف بيانات الفني</h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" value="{{ old('date_of_employment') }}" id="date_of_employment"
                                                               class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('qualifications') }}" id="qualifications"
                                                               class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('previous_experience') }}" id="previous_experience"
                                                               class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="technical_skills" id="profession" class="form-control">
                                                        ...
                                                        <option value="0" @if(old('technical_skills') == '0') selected @endif>فني</option>
                                                        <option value="1" @if(old('technical_skills') == '1') selected @endif>مساعد</option>
                                                    </select>
