...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('assets/admin/images/logo/alwadi.png') }}">
...
<script src="{{ asset('assets/admin/js/pusher-comment.js') }}" type="text/javascript"></script>
<!-- End pusher JS-->
<!-- BEGIN VENDOR JS-->
